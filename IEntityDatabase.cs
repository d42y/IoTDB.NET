...
namespace IoTDB.NET
{
    public interface IEntityDatabase
    {
        ...
        List<(string PropertyName, BsonValue Value, DateTime Timestamp)> GetProperties(string guid);
        ...
        List<(string PropertyName, BsonValue Value, DateTime Timestamp)> GetProperties(string guid, params string[] propertyNames);
